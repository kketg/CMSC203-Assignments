...
class TelevisionDemo {
  public static void main(String[] args) {
    // create a Scanner object to read from the keyboard
		...
		System.out.println(
				"A " + bigScreen.getScreenSize() + "-inch " + bigScreen.getManufacturer() + " has been turned on.");
		...
		portable.power();
		System.out.println("The " + portable.getManufacturer() + " " + portable.getScreenSize() + "-inch was turned on.");
