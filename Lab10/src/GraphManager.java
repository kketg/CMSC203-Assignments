...
/**
 * The manager deals with the specified functions, i.e., selecting the function
 * that the user wants, setting the x-axis and y-axis extents that the user
 * wants plotted, getting the function value at a specified x, and getting the y
 * value to be drawn on the GUI.
 * 
 * @author ralexander
 *
 */
